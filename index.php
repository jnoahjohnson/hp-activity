    ...
    <body>
	    ...
	    <div class="jumbotron main-banner" id="scores">
	      <div class="container centerText">
		  	...
		  	<div class="wecomeMessage" style="background: rgba(51, 102, 153, .9); margin-bottom: 40px; padding-left: 40px; padding-right: 40px; width: 70%; display: inline-block; padding-top: 10px; padding-bottom: 5px;">
			  	<p>Congratulations to Ravenclaw who won The Potter Cup!</p>
